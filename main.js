...
var musicData = [
  {
    ...
    duration: '3:45',
    lyrics: 'Words that matter, truth in every bar...',
    explanation: 'This track talks about keeping it real and speaking truth. Every verse is about authentic expression and not caring about the fake world around us.',
    src: 'Antim Patra.mp4',
...
var projectsData = [
  {
    ...
    date: 'Coming Soon',
    description: 'A full-length album exploring themes of struggle and growth. 10+ tracks of pure hip-hop.',
    status: 'In Progress'
  },
  {
    title: 'Collaboration EP',
    date: 'Q2 2025',
    description: 'Working with talented producers and fellow artists to create something special.',
    status: 'Pre-Production'
  },
  {
    title: 'Live Sessions',
    date: 'Q3 2025',
    description: 'Studio recordings of acoustic performances of popular tracks with behind-the-scenes stories.',
    status: 'Planned'
  }
];
  ...
  lyricsGrid.innerHTML = musicData.map(function(track) {
    return '<div class="lyrics-card">' +
      '<div class="lyrics-card-header">' +
        ...
        '<span class="duration">' + escHtml(track.duration) + '</span>' +
      '</div>' +
      '<div class="lyrics-preview">"' + escHtml(track.lyrics) + '"</div>' +
      '<div class="lyrics-explanation"><strong>Story:</strong> ' + escHtml(track.explanation) + '</div>' +
    '</div>';
  }).join('');
}
